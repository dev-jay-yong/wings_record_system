...
@router.get(path="/introduction", response_model=TeamIntroductionResponse)
...
@router.get(path="/players", response_model=TeamPlayersResponse)
...
@router.get(path="/record/{record_type}", response_model=TeamRecordResponse)
...
@router.get(path="/player/{player_id}")
...
@router.get(path="/history/{team_id}")
